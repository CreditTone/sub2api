export default {
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        limit5Hour: '5-Hour Limit (USD)',
        limit5HourHint: 'Applies a fixed 5-hour subscription quota window. Leave empty for no limit.',
        limit5HourMigrateHint: 'This group currently uses a {hours}-hour custom window. Saving will convert it to a 5-hour window.',
        customWindowHours: 'Custom Window (Hours)',
        customWindowHoursPlaceholder: 'e.g. 5',
        customLimit: 'Custom Window Limit (USD)',
  ...
  payment: {
    ...
    admin: {
      ...
      dailyLimit: 'Daily Limit',
      limit5Hour: '5-Hour Limit',
      weeklyLimit: 'Weekly Limit',
      monthlyLimit: 'Monthly Limit',
      limitHourWindow: '{hours}-Hour Limit',
      unlimited: 'Unlimited',
