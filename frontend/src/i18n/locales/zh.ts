  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        limit5Hour: '5 小时限额（USD）',
        limit5HourHint: '固定按 5 小时窗口限制订阅额度，留空表示不限制',
        limit5HourMigrateHint: '当前分组存在 {hours} 小时自定义窗口；本次保存后将按 5 小时窗口生效。',
        customWindowHours: '自定义窗口（小时）',
        customWindowHoursPlaceholder: '例如：5',
        customLimit: '自定义窗口限额（USD）',
